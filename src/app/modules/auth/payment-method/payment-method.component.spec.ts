...
import { AuthorizeNetComponent } from './payment-method.component';
...
describe('AuthorizeNetComponent', () => {
  let component: AuthorizeNetComponent;
  let fixture: ComponentFixture<AuthorizeNetComponent>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      declarations: [AuthorizeNetComponent],
      providers: [
    ...
    fixture = TestBed.createComponent(AuthorizeNetComponent);
